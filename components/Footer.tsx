      ...
      <div className="mx-auto grid max-w-6xl gap-10 md:grid-cols-4">
        <div>
          <Link href="/" className="inline-flex items-center" aria-label="BuiltForFree home">
            <Image src="/logo.svg" alt="BuiltForFree" width={119} height={25} className="h-[25px] w-auto" />
          </Link>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
            ...
            <li><a href="/#form" className="font-medium text-foreground hover:text-foreground">Get my free website</a></li>
          </ul>
        </div>
      </div>
