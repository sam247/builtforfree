...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    { url: `${baseUrl}/areas`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.81 },
    { url: `${baseUrl}/free-website-uk`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    {
      url: `${baseUrl}/free-website-for-small-business-uk`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.88,
    },
    { url: `${baseUrl}/free-website-vs-diy-uk`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.86 },
